...
- **使用者 = 客戶端**:負責實機驗測與使用回饋,不寫程式。需要實體操作
  (車邊、工作站 GUI、場域)的事項一律交給使用者,列清楚步驟。
- 分層待辦見 `docs/V1_GATE.md`。
...
3. **功能真的能用**:照 `docs/TEST.md` 實測受影響的鏈路,不能只靠單元測試綠
...
## 鐵律(見 docs/PROJECT_DIRECTION.md)
