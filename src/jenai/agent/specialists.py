...
def build_ros_explorer_agent(config: AppConfig) -> Agent[JenAIRunContext]:
...
def build_motion_agent(config: AppConfig) -> Agent[JenAIRunContext]:
    return Agent[JenAIRunContext](
        name="Motion",
...
def build_supervisor_agent(config: AppConfig) -> Agent[JenAIRunContext]:
    ...
    return Agent[JenAIRunContext](
        ...
        handoffs=[
            build_ros_explorer_agent(config),
            build_motion_agent(config),
            build_navigation_agent(config),
            build_perception_agent(config),
        ],
    )
