"""Agent adapter for the deterministic semantic area-patrol workflow."""
...
_AREA_PATROL_INFO = ToolRiskInfo(
...
def _record_call(
    ...
    call = ToolCallRecord(
        ...
        risk_level=_AREA_PATROL_INFO.risk_level,
        effect_scope=_AREA_PATROL_INFO.effect_scope,
    )
...
def _step_verdict(output: RouteOutput) -> StepVerdict:
    ...
    if status == "unavailable":
        return StepVerdict.UNAVAILABLE
...
register_tool("area_patrol_workflow_tool", _AREA_PATROL_INFO)
