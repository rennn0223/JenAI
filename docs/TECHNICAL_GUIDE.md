...
---
*其他現行文件：[PROJECT_DIRECTION](PROJECT_DIRECTION.md)（方向與 roadmap）、[COMMANDS](COMMANDS.md)（指令規格）、[UX](UX.md)（介面基準）。v0.1 規劃文件已集中至 [設計歸檔](archive/design/README.md)，現況以本指南與程式碼為準。*
